						...
						<article id="post-25" class="post-25 page type-page status-publish hentry">
							<div class="entry-content">
								...
								<div class="formulair-contact">
									...
									if (isset($_GET['status'])) {
										if ($_GET['status'] == 'success') {
											...
											echo '<strong>Succès !</strong> Votre demande de visite a été envoyée avec succès. Nous vous recontacterons bientôt !';
											if (isset($_GET['email_status']) && $_GET['email_status'] == 'email_sent') {
												echo '<br><em>Un email de confirmation a été envoyé à votre adresse email.</em>';
											}
											echo '</div>';
											...
											if (isset($_GET['reason'])) {
												if ($_GET['reason'] == 'validation') {
													...
													echo 'Une erreur s\'est produite lors de l\'enregistrement de votre demande. Veuillez réessayer.';
												}
											} else {
								...
								<div class="list-contact">
									...
									<ul>
										<li>Nos espaces d’éveil, conçus pour favoriser l’autonomie et la créativité des
											enfants ;</li>
										<li>Notre équipe pédagogique passionnée, qui veille au bien-être et au
								...
								<div class="reseau">
									...
									<strong>Nous serons ravis de vous accueillir bientôt !</strong>
								...
								<iframe loading="lazy"
										...
										title="Crèche minibulle, 27 Rue de Guise, Casablanca 20290"
										aria-label="Crèche minibulle, 27 Rue de Guise, Casablanca 20290"></iframe>
								</div>
