<?php
$page_title = "Approche pédagogique - Minibulle";
include '../header.php';
?>

<body
    class="wp-singular page-template-default page page-id-194 wp-custom-logo wp-theme-grand-academy-pro-premium no-sidebar full-width menu-sticky section-title-font-18 header-font-1 body-font-11">
    <?php
include '../topbar.php';
?>

    <body class="wp-singular page-template-default page page-id-194 wp-custom-logo wp-theme-grand-academy-pro-premium no-sidebar full-width menu-sticky section-title-font-18 header-font-1 body-font-11">

        <div id="page" class="site">
            
            <div id="content" class="site-content">
                <div id="page-site-header"
                    style="background-image: url('https://crecheminibulle.ma/wp-content/uploads/2025/01/cropped-cropped-cropped-pexels-naomi-shi-374023-1001914-scaled-1.jpg');">
                    ...
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main" role="main">
                            ...
                            <article id="post-194" class="post-194 page type-page status-publish hentry">
                                <div class="">
                                    <div class="object_aproche d-flex">
                                        <div class="image-object">
                                            <img decoding="async" width="640" height="453"
                                                src="https://crecheminibulle.ma/wp-content/uploads/2025/02/dfc5faff-f557-4e57-818c-6518816b0416-1024x724.png"
                                                alt=""
                                        ...
                                        <div class="text">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    Promouvoir l’excellence éducative
                                                </li>
                                                <li>
                                                    <svg aria-hidden="true" viewBox="0 0 512 512"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    Encourager l’harmonisation des pratiques éducatives.
                                                </li>
                                                <li>
                                                    <svg aria-hidden="true" viewBox="0 0 512 512"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    Favoriser la fluidité et la continuité des apprentissages
                                                </li>
                                            </ul>
                                            ...
                                            <p>Le recrutement du personnel se fait en fonction de son expérience dans le
                                                domaine de l’éducation et de l’apprentissage, ainsi que ses qualités telles que
                                                la confiance, la patience, la bienveillance, la créativité, l’adaptabilité la
                                                communication…
                                            </p>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Encourager le développement de la curiosité et de l’esprit ouvert chez les
                                            enfants.
                                        </li>
                                        <li>
                                            <svg aria-hidden="true" viewBox="0 0 512 512"
                                            ...
                                            Favoriser une meilleure concentration du cerveau grâce à un apprentissage
                                            trilingue.
                                        </li>
                                        <li>
                                            <svg aria-hidden="true" viewBox="0 0 512 512"
                                            ...
                                            Stimuler les capacités métacognitives et métalinguistiques chez l’enfant.
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                    ...
                                    <p> <img decoding="async" width="640" height="960"
                                            src="https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-683x1024.jpg"
                                            alt=""
                                            srcset="https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-683x1024.jpg 683w, https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-200x300.jpg 200w, https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-768x1152.jpg 768w, https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-1024x1536.jpg 1024w, https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-1365x2048.jpg 1365w, https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-8x12.jpg 8w, https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1-600x900.jpg 600w, https://crecheminibulle.ma/wp-content/uploads/2025/02/pexels-cottonbro-3661351-scaled-1-1.jpg 1600w"
                                    ...
                                    <h3>
                                        Bienveillance et sécurité<br>
                                    </h3>
                                    <p>
                                        Garantir un environnement sûr et chaleureux, où chaque enfant se sent protégé et
                                        épanoui. </p>
                                    <p> <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" height="800px" width="800px"
                                            id="_x32_" viewBox="0 0 512 512" xml:space="preserve"></svg></p>
                                    <style type="text/css">
                                        .st0 {
                                            fill: #000000;
                                        }
                                    ...
                                    <h3>
                                        Collaboration avec les familles<br>
                                    </h3>
                                    <p>
                                        Instaurer un partenariat étroit avec les parents afin d’accompagner au mieux
                                        chaque enfant dans son développement </p>
                                </div><!-- .entry-content -->
