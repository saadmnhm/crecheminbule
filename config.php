...
$page_seo = [
    'en' => [
        'index.php' => [
            'title' => 'Minibulle - Nursery & Kindergarten in Rabat Morocco',
            'description' => 'Premium trilingual nursery and kindergarten in Rabat. Quality early childhood education with French, English and Arabic programs. Modern facilities and caring environment.',
            'keywords' => 'nursery rabat, kindergarten morocco, trilingual education, early childhood, creche rabat, preschool morocco',
            'og_title' => 'Minibulle - Premium Nursery & Kindergarten Rabat',
            'og_description' => 'Discover our trilingual nursery in Rabat offering quality early childhood education in a modern, caring environment.'
        ],
        'a_propos.php' => [
            'title' => 'About Us - Minibulle Nursery Rabat',
            'description' => 'Learn about Minibulle nursery - our educational approach, experienced staff, and commitment to quality early childhood development in Rabat.',
            'keywords' => 'about minibulle, nursery staff, educational approach, rabat kindergarten team',
        ...
        'espace.php' => [
            'title' => 'Our Facilities - Modern Nursery Spaces in Rabat',
            ...
            'keywords' => 'nursery facilities, modern classrooms, safe environment, play areas rabat',
        ...
        'inscription.php' => [
            'title' => 'Enrollment - Join Minibulle Nursery Rabat',
            'description' => 'Enroll your child at Minibulle nursery in Rabat. Simple enrollment process for quality trilingual early childhood education.',
            'keywords' => 'nursery enrollment rabat, kindergarten registration, join minibulle, admission process',
        ...
        'contact.php' => [
            'title' => 'Contact Us - Minibulle Nursery Rabat',
            'description' => 'Contact Minibulle nursery in Rabat. Get information about enrollment, programs, and visit our facilities. We\'re here to help!',
            'keywords' => 'contact nursery rabat, minibulle phone, nursery address rabat, kindergarten contact',
        ...
        'blog.php' => [
            ...
            'description' => 'Read our blog for expert tips on early childhood education, parenting advice, and news from Minibulle nursery in Rabat.',
            'keywords' => 'parenting tips, child development blog, early education advice, nursery news rabat',
        ...
        'evenements.php' => [
            'title' => 'Events & Activities - Minibulle Nursery Rabat',
            ...
            'keywords' => 'nursery events rabat, children activities, educational workshops, kindergarten celebrations',
    ...
    'fr' => [
        'index.php' => [
            'title' => 'Minibulle - Crèche & Maternelle Trilingue à Rabat Maroc',
            'description' => 'Crèche et maternelle trilingue de qualité à Rabat. Éducation préscolaire d\'excellence avec programmes français, anglais et arabe. Installations modernes et environnement bienveillant.',
            'keywords' => 'crèche rabat, maternelle maroc, éducation trilingue, petite enfance, pouponnière rabat, préscolaire maroc',
            'og_title' => 'Minibulle - Crèche & Maternelle Trilingue Premium Rabat',
            'og_description' => 'Découvrez notre crèche trilingue à Rabat offrant une éducation préscolaire de qualité dans un environnement moderne et bienveillant.'
        ],
        'a_propos.php' => [
            'title' => 'À Propos - Crèche Minibulle Rabat',
            'description' => 'Découvrez la crèche Minibulle - notre approche pédagogique, équipe expérimentée, et engagement pour le développement de la petite enfance à Rabat.',
            'keywords' => 'équipe minibulle, approche pédagogique, crèche rabat équipe, éducatrices qualifiées',
        ...
        'espace.php' => [
            'title' => 'Nos Espaces - Infrastructure Moderne Crèche Rabat',
            ...
            'keywords' => 'installations crèche, salles modernes, environnement sécurisé, aires de jeux rabat',
        ...
        'inscription.php' => [
            'title' => 'Inscription - Rejoignez la Crèche Minibulle Rabat',
            'description' => 'Inscrivez votre enfant à la crèche Minibulle à Rabat. Processus d\'inscription simple pour une éducation préscolaire trilingue de qualité.',
            'keywords' => 'inscription crèche rabat, admission maternelle, rejoindre minibulle, processus inscription',
        ...
        'contact.php' => [
            'title' => 'Nous Contacter - Crèche Minibulle Rabat',
            'description' => 'Contactez la crèche Minibulle à Rabat. Obtenez des informations sur les inscriptions, programmes, et visitez nos installations. Nous sommes là pour vous aider!',
            'keywords' => 'contact crèche rabat, téléphone minibulle, adresse crèche rabat, contact maternelle',
        ...
        'blog.php' => [
            ...
            'description' => 'Lisez notre blog pour des conseils d\'experts sur l\'éducation préscolaire, conseils parentaux, et actualités de la crèche Minibulle à Rabat.',
            'keywords' => 'conseils parentaux, blog développement enfant, conseils éducation préscolaire, actualités crèche rabat',
        ...
        'evenements.php' => [
            'title' => 'Événements & Activités - Crèche Minibulle Rabat',
            ...
            'keywords' => 'événements crèche rabat, activités enfants, ateliers éducatifs, célébrations maternelle',
...
function get_page_seo($page_name, $language = 'en') {
    ...
    if (isset($page_seo[$language][$page_name])) {
        ...
        return [
            ...
            'description' => 'Premium nursery and kindergarten in Rabat, Morocco. Quality early childhood education in a modern, caring environment.',
            'keywords' => 'nursery rabat, kindergarten morocco, early childhood education',
            'og_title' => $seo_config['site_name'],
            'og_description' => 'Quality early childhood education in Rabat, Morocco.'
        ];
    }
}
